...
import  time #tcw20181015tcw
import os.path #tcw20181015tcw
...
def main():
    # Build model
    save_dir =  'sigma' + str(opt.test_noiseL) + '_' + time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime()) + opt.test_data + '/' 
